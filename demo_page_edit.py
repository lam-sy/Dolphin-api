...
def process_elements(layout_results, padded_image, dims, model, max_batch_size, save_dir=None, image_name=None):
    ...
    if text_table_elements:
        ...
        for i, result in enumerate(batch_results):
            ...
            # If the element is a table, parse the HTML string into a list of lists
            if elem["label"] == "tab" and text_content.startswith("<table>"):
                try:
                    ...
                    print(f"Could not parse HTML table for element {elem['reading_order']}: {e}")
